...
if not exist "Z:\kimigpt\config" mkdir "Z:\kimigpt\config"
if not exist "Z:\kimigpt\output" mkdir "Z:\kimigpt\output"
if not exist "Z:\kimigpt\uploads" mkdir "Z:\kimigpt\uploads"
...
echo       - Open api.txt for detailed instructions
...
echo ═══════════════════════════════════════════════════════════════
echo.
echo    📖 Read api.txt for detailed API setup instructions
echo.
